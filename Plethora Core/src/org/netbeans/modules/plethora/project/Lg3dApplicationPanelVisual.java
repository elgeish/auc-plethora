 ...
 *
 * Lg3dApplicationPanelVisual.java
...
/**
 * Visual representation of the wizard contains buttons, text fields, etc
 *
 * @author Mohamed El-Geish 
 * @version 1.00
 */
public class Lg3dApplicationPanelVisual extends JPanel implements DocumentListener {
    
    public static final String PROP_PROJECT_NAME = "projectName";
    
    private Lg3dApplicationWizardPanel panel;
    private int type;
    
    /** Creates new form PanelProjectLocationVisual */
    public Lg3dApplicationPanelVisual(Lg3dApplicationWizardPanel panel) {
        initComponents();
        this.panel = panel;
        this.type = type;
